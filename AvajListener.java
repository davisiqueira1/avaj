...
public interface AvajListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AvajParser#param}.
	 * @param ctx the parse tree
	 */
	void enterParam(AvajParser.ParamContext ctx);
	/**
	 * Exit a parse tree produced by {@link AvajParser#param}.
	 * @param ctx the parse tree
	 */
	void exitParam(AvajParser.ParamContext ctx);
	/**
	 * Enter a parse tree produced by {@link AvajParser#block}.
	 * @param ctx the parse tree
	 */
	void enterBlock(AvajParser.BlockContext ctx);
	/**
	 * Exit a parse tree produced by {@link AvajParser#block}.
	 * @param ctx the parse tree
	 */
	void exitBlock(AvajParser.BlockContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link AvajParser#exprStmt}.
	 * @param ctx the parse tree
	 */
	void enterExprStmt(AvajParser.ExprStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link AvajParser#exprStmt}.
	 * @param ctx the parse tree
	 */
	void exitExprStmt(AvajParser.ExprStmtContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link AvajParser#value}.
	 * @param ctx the parse tree
	 */
	void enterValue(AvajParser.ValueContext ctx);
	/**
	 * Exit a parse tree produced by {@link AvajParser#value}.
	 * @param ctx the parse tree
	 */
	void exitValue(AvajParser.ValueContext ctx);
	/**
	 * Enter a parse tree produced by {@link AvajParser#funCall}.
	 * @param ctx the parse tree
	 */
	void enterFunCall(AvajParser.FunCallContext ctx);
	/**
	 * Exit a parse tree produced by {@link AvajParser#funCall}.
	 * @param ctx the parse tree
	 */
	void exitFunCall(AvajParser.FunCallContext ctx);
	/**
